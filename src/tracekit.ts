module TraceKit {
    ...
    export var remoteFetching;
    export var collectWindowErrors;
    export var linesOfContext;
    ...
    export var report = (function reportModuleWrapper() {
         ...
         * @param {Error} ex
         */
        var report:any = function report(ex) {
            if (lastExceptionStack) {
                if (lastException === ex) {
    ...
    export var computeStackTrace = (function computeStackTraceWrapper() {
         ...
         * @param {(string|number)=} depth
         */
        var computeStackTrace : any = function computeStackTrace(ex, depth) {
            var stack = null;
        ...
        return <ComputeStackTrace> computeStackTrace;
    } ());
    ...
    export function extendToAsynchronousCallbacks() {
        var _helper = function _helper(fnName) {
            var originalFn = <any>window[fnName];
            (<any>window)[fnName] = function traceKitAsyncExtension() {
